def sylvia():
    ...
    window1.image=PhotoImage(file="red bow.png")
...
def mahmood():
    ...
    window2.image2=PhotoImage(file="broken heart.png")
...
def albert():
    ...
    window3.image3=PhotoImage(file="clock.png")
...
def kafka():
    ...
    window4.image4=PhotoImage(file="cup.png")
...
image= PhotoImage(file="blue flowers.png")
